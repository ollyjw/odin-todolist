...
// Project form
function grabProjectFormData(event) {
    ...
    let newProject = (0,_projects_js__WEBPACK_IMPORTED_MODULE_0__.createProject)(projectTitleValue, projectDescriptionValue);
...
function addNewProjectToArray(newProject) {
